...
describe('BowlingGame', () => {
  ...
  game.roll(6);   // 1st frame, second roll: Spare (10 pins + 5 bonus)
  game.roll(10);  // 2nd frame, first roll: Strike (10 pins + 5 + 3 bonus)
  game.roll(5);   // 3rd frame, first roll: 5 pins
  game.roll(3);   // 3rd frame, second roll: 3 pins
  game.roll(4);   // 4th frame, first roll: 4 pins
  game.roll(6);   // 4th frame, second roll: Spare (10 pins + 5 bonus)
  game.roll(10);  // 5th frame, first roll: Strike (10 pins + 5 + 3 bonus)
  game.roll(5);   // 6th frame, first roll: 5 pins
  game.roll(3);   // 6th frame, second roll: 3 pins
  game.roll(4);   // 7th frame, first roll: 4 pins
  game.roll(6);   // 7th frame, second roll: Spare (10 pins + 5 bonus)
  game.roll(10);  // 8th frame, first roll: Strike (10 pins + 5 + 3 bonus)
  game.roll(5);   // 9th frame, first roll: 5 pins
  game.roll(3);   // 9th frame, second roll: 3 pins
  game.roll(4);   // 10th frame, first roll: 4 pins
  game.roll(6);   // 10th frame, second roll: Spare (10 pins + 5 bonus)
